		...
		<c:choose>
                ...
                <div id="ca-container11" class="ca-container11">
                    <div class="ca-content">
                        ...
                        <div class="ca-content-text">
                            <p>In this section you can find projects for the Fall Semester courses of Fourth Year. You can see some statistics below.</p>
			</div>
            ...
            <div id="loginmodal" style="display:none;">
                ...
                <form id="loginform" action="../Login" method="post">
                    ...
                    <input type="hidden" name="url" value="6notification.jsp"/>
