		...
		<c:choose>
            ...
            <div align="center">
                <div id="ca-container11" class="ca-container11">
                    <div class="ca-content">
                        <h6 align="center">Spring Semester</h6>
                        <div class="ca-content-text">
                            <p>In this section you can find projects for the Spring Semester courses of Fourth Year. You can see some statistics below.</p>
			</div>
            ...
            <div id="loginmodal" style="display:none;">
                ...
                <form id="loginform" action="../Login" method="post">
                    ...
                    <input type="hidden" name="url" value="7notification.jsp"/>
