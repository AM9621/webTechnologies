...
<html lang="en">
    ...
    <c:choose>
        <c:when test="${empty sessionScope.email}">
            <c:import url="8notification.jsp"></c:import>
        </c:when>
        <c:otherwise>
            ...
            <form action="../UploadDownloadFileServlet" id="popupform1" class="popup-form" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="course" value="LinearAlgebra"/>
            </form>
            ...
            <div class="container">
                ...
                <sql:query dataSource="${ds}" sql="select * from courseMaterials where course='LinearAlgebra' order by rank desc" var="results" />
