...
<html lang="en">
    ...
    <c:choose>
        <c:when test="${not empty sessionScope.email}">
            <c:import url="9projects.jsp"></c:import>
        </c:when>
        <c:otherwise>
                ...
                <div id="ca-container11" class="ca-container11">
                    <div class="ca-content">
                        ...
                        <div class="ca-content-text">
                            <p>In this section you can find projects for the Web Technologies course. You can see some statistics below.</p>
                            <p>If you want to see the projects you must <strong>Login</strong>.</p>
			</div>
