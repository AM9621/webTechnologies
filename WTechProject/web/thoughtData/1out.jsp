...
<html lang="en">
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0"> 
        ...
        <meta name="keywords" content="jquery, Repository, Course, Servlet" />
    ...
    <body>
		...
		<c:choose>
                ...
                <div id="ca-container11" class="ca-container11">
                    <div class="ca-content">
                        ...
                        <div class="ca-content-text">
                            <p>Welcome to <strong>RepoCourse</strong>. Here you can find student projects from University of Thessaly. You can see statistics of projects below.</p>
			</div>
            ...
            <div id="loginmodal" style="display:none;">
                ...
                <form id="loginform" action="../Login" method="post">
                    ...
                    <input type="hidden" name="url" value="test1.jsp"/>
        ...
        <sql:query dataSource="${ds}" sql="select * from courseMaterials where course='WebTechnologies'" var="webTech" />
		...
		data: [              
		{
			...
			dataPoints: [
				...
				{ label: "Web Technologies", y: ${webTech.getRowCount()}  },
                                { label: "Other", y: 8  }
