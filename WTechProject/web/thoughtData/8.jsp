		...
		<c:choose>
            ...
            <div align="center">
                <div id="ca-container11" class="ca-container11">
                    <div class="ca-content">
                        <h6 align="center">Linear Algebra</h6>
                        <div class="ca-content-text">
                            <p>In this section you can find projects for the Linear Algebra course. You can see some statistics below.</p>
            ...
            <div id="loginmodal" style="display:none;">
                ...
                <form id="loginform" action="../Login" method="post">
                    ...
                    <input type="hidden" name="url" value="8notification.jsp"/>
